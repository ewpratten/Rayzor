...
public class Cornell implements IScene {
    ...
    private void addObjects(Scene scene) {
        ...
        scene.addObject(
                new Sphere(new Vector3(-3.0, -4.0, -12.0), 3.0, new Material(new Color3f(Color.WHITE), 1.0, true)));
        scene.addObject(
                new Sphere(new Vector3(1.0, -2.0, -10.0), 1.0, new Material(new Color3f(0.8f, 0.1f, 0.1f), 0.8, false)));

    }

    private void addLighting(Scene scene) {
        // scene.addLight(new SphericalLight(new Vector3(0.0, 8.0, -8.0), new Color3f(0.6f, 0.6f, 0.6f), 20000));

        scene.addLight(new DirectionalLight(new Vector3(-0.25, -1.0, -1.0), new Color3f(1.0f, 1.0f, 1.0f), 1.0));
        // scene.addLight(new SphericalLight(new Vector3(0.25, 0.0, 0.0), new
        // Color3f(0.8f, 0.2f, 0.3f), 3000.0));
        // scene.addLight(new SphericalLight(new Vector3(-2.0, 10.0, -3.0), new
        // Color3f(1.0f, 1.0f, 1.0f), 30000.0));
